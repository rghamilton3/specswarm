...
/ss:validate /path/to/my-app

# Override detected type
/ss:validate /path/to/project --type webapp

# Use custom flows
/ss:validate --flows ./custom-flows.json

# Override base URL
/ss:validate --url http://localhost:3000
```
...
/ss:build "Add shopping cart" --validate

# Manual validation with session tracking
/ss:validate /path/to/project --session-id feature_20251103_143022
```
...
/ss:validate && echo "Deploy approved" || echo "Fix errors before deploy"
```
